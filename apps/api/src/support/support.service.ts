...
export const FAQ_ITEMS = [
  {
    ...
    answer:
      'Самостоятельный сброс пароля пока недоступен. Напишите нам в поддержку прямо в этом чате — укажите email аккаунта, мы проверим и поможем сменить пароль.',
  },
  {
    id: 'verify-account',
    question: 'Нужно ли подтверждать аккаунт?',
    answer:
      'Нет, подтверждение аккаунта не требуется — можно сразу пополнять баланс и играть после регистрации.',
  },
  {
    id: 'deposit-how',
    question: 'Как пополнить баланс?',
    answer:
      'Пополнение доступно только в криптовалюте. Зайдите в раздел «Кошелёк» → «Пополнить», выберите монету и сеть, отправьте средства на указанный адрес — баланс обновится автоматически после подтверждений в сети.',
  },
  {
    id: 'payment-not-going',
    question: 'Депозит не зачисляется',
    answer:
      'Проверьте, что перевод отправлен именно на адрес и в той сети, что были указаны при создании депозита. Обычно зачисление занимает несколько минут после нужного числа подтверждений в блокчейне. Если прошло больше времени — напишите нам в поддержку и приложите хеш транзакции (TXID), мы проверим вручную.',
  },
  {
    id: 'withdrawal-time',
    question: 'Сколько идёт вывод средств?',
    answer:
      'Вывод обрабатывается в течение 24 часов. Всё честно, без скрытых задержек — если лимит времени превышен, напишите в поддержку, и мы разберёмся.',
  },
  {
    id: 'withdrawal-methods',
    question: 'Куда выводятся средства?',
    answer:
      'Вывод, как и пополнение, идёт только в криптовалюте — на указанный вами адрес кошелька. Перед выводом дважды проверьте адрес и сеть: отправленное на неверный адрес вернуть невозможно.',
  },
  {
    id: 'min-deposit',
    question: 'Есть ли минимальная сумма пополнения?',
    answer:
      'Минимальная сумма зависит от выбранной монеты и сети — она указывается прямо на странице пополнения перед отправкой средств.',
  },
];
