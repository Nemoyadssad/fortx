...
export default function JackpotPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#07050d]">
      {/* nebula backdrop — scoped to this section (absolute, not fixed) so it can never paint over the sitewide Footer */}
      <div
      ...
      />
      <div className="pointer-events-none absolute inset-0 z-0 bg-gradient-to-b from-[#07050d]/70 via-[#07050d]/40 to-[#07050d]" />
      <div className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_top,rgba(167,139,250,0.12),transparent_60%)]" />
